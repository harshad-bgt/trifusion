                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
                    ...
                    <div className="lg:col-span-2">
                        <Link href="/" className="inline-block mb-5 bg-white p-2.5 rounded-xl border border-white/20 shadow-sm">
                            ...
                            <img src="/logo-header.png" alt="TriFusion Tech LLP" className="h-9 w-auto object-contain" />
                        </Link>
                        <p className="text-slate-300 text-sm leading-relaxed max-w-xs mb-6">
                            Custom software &amp; smart GST accounting systems for businesses ready to grow. Pune-based, India-focused.
                        </p>
                        {/* Contact */}
                        <div className="space-y-2.5">
                            <a href={`tel:+919309505277`} className="flex items-center gap-2 text-slate-300 hover:text-white text-sm transition-colors" aria-label="Call TriFusion Tech LLP">
                                <Phone className="w-4 h-4 text-blue-400 flex-shrink-0" aria-hidden="true" />
                                +91 93095 05277
                            </a>
                            <a href="https://wa.me/919309505277" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-slate-300 hover:text-green-400 text-sm transition-colors" aria-label="WhatsApp TriFusion Tech LLP">
                                <WhatsAppIcon className="w-4 h-4 text-green-400 flex-shrink-0" />
                                +91 93095 05277 (WhatsApp)
                            </a>
                            <a href={`mailto:${siteConfig.contact.email}`} className="flex items-center gap-2 text-slate-300 hover:text-white text-sm transition-colors" aria-label={`Email ${siteConfig.contact.email}`}>
                                <Mail className="w-4 h-4 text-blue-400 flex-shrink-0" aria-hidden="true" />
                                {siteConfig.contact.email}
                            </a>
                            <a href={siteConfig.contact.mapsUrl} target="_blank" rel="noopener noreferrer" className="flex items-start gap-2 text-slate-300 hover:text-white text-sm transition-colors" aria-label="View office location on Google Maps">
                        ...
                        <div className="flex items-center gap-3 mt-6">
                            {siteConfig.social.linkedin && (
                                <a href={siteConfig.social.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
                                    className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center text-slate-300 hover:bg-[#0A66C2] hover:text-white transition-all">
                                    <LinkedinIcon className="w-4 h-4" />
                                </a>
                            )}
                            {siteConfig.social.instagram && (
                                <a href={siteConfig.social.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                                    className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center text-slate-300 hover:bg-gradient-to-br hover:from-[#f09433] hover:to-[#bc1888] hover:text-white transition-all">
                                    <InstagramIcon className="w-4 h-4" />
                                </a>
                            )}
                            {siteConfig.social.facebook && (
                                <a href={siteConfig.social.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook"
                                    className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center text-slate-300 hover:bg-[#1877F2] hover:text-white transition-all">
                                    <FacebookIcon className="w-4 h-4" />
                                </a>
                            )}
                            {siteConfig.social.twitter && (
                                <a href={siteConfig.social.twitter} target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)"
                                    className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center text-slate-300 hover:bg-black hover:text-white transition-all">
